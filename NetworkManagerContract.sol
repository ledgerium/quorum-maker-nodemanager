...
contract NetworkManagerContract {
    ...
    function getNodeDetails(uint16 _index) view public returns (string memory n, string memory r, string memory p, string memory ip, string memory e, string memory id, uint i) {
